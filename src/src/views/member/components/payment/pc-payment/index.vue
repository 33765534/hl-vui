<template>
  <div>
    ...
    <Discounts></Discounts>
    <div
      class="flex flex-col items-center justify-evenly border-zinc-200 dark:border-zinc-700"
    >
      <p class="text-[32px] text-orange-600 font-sans">
        <span class="text-base text-zinc-900 dark:text-zinc-900">
          支付金额：
        </span>
        <span class="text-lg mr-[-12px]">￥</span>19
      </p>
      <div class="flex mt-3">
        <!-- 支付宝支付 -->
        <div
          ...
          @click="onAliPayClick"
        >
          <img class="w-4 j-4" src="@/assets/images/alipay.png" alt="" />
